...
import frc.robot.commands.swervedrive.drivebase.ToggleDriveModeCommand;
...
public class RobotContainer
{
  ...
  public RobotContainer()
  {
    ...
    drivebase.setDefaultCommand(!RobotBase.isSimulation() ? closedAbsoluteDrive : simClosedFieldRel);
    new JoystickButton(driverXbox, 1).onTrue(new ToggleDriveModeCommand(closedAbsoluteDrive,closedFieldRel,drivebase));
  }
